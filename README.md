...
- **A path from zero** — a sixty-stage course, 237 lessons, every Japanese word shown with its romaji, for anyone who has never studied Japanese; each stage teaches the idea then sends you to the tool that drills it
